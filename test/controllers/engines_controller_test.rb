...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference("Engine.count") do
      post engines_url, params: { engine: { code: @engine.code, displacement: @engine.displacement, horsepower: @engine.horsepower } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { code: @engine.code, displacement: @engine.displacement, horsepower: @engine.horsepower } }
